...
document.getElementsByTagName('title')[0].innerHTML = config.appName
document.getElementsByClassName('system-icon')[0].src = './image/'+icon
document.getElementsByClassName('logo')[0].src = './image/'+config.appName+'.png?'+parseInt(Math.random()*10000)

// 下载操作
var download = document.getElementsByClassName('download')[0]
var point = document.getElementsByClassName('point')[0]
var iosInfo = document.getElementsByClassName('iosInfo')[0]
if (isWeixin) {
